...
def build_learned_quality_ablation_notebook(
    commit_sha: str,
    *,
    ...
    cells = [
        ...
        nbformat.v4.new_code_cell(
            ...
            "assert not raw_folder.endswith(('_result', '_training_ablation', "
        ...
        nbformat.v4.new_code_cell(
            ...
            "    LEARNED_ENV, downloader=snapshot_download, "
    ...
    notebook = nbformat.v4.new_notebook(
        ...
        metadata={
            ...
            "generator": {
                "id": "4dgs-studio.learned-training-ablation-notebook",
                "version": 1,
...
def write_learned_quality_ablation_notebook(
    path: Path,
    commit_sha: str,
) -> Path:
    notebook = build_learned_quality_ablation_notebook(commit_sha=commit_sha)
...
def main(argv: list[str] | None = None) -> int:
    ...
    write_learned_quality_ablation_notebook(args.output, args.commit)
    return 0
